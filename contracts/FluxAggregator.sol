...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
    ...
    HashBridgeOracleTokenInterface public hashBridgeOracleToken;
     ...
     * reserve of RESERVE_ROUNDS * oracleCount() HBO earmarked for payment to
     ...
     * @param _paymentAmount The amount paid of HBO paid to each oracle per submission, in wei (units of 10⁻¹⁸ HBO)
    ...
    constructor(
        ...
        hashBridgeOracleToken = HashBridgeOracleTokenInterface(_hbo);
    ...
    /**
     * @notice recalculate the amount of HBO available for payouts
     */
    function updateAvailableFunds() public {
        Funds memory funds = recordedFunds;

        uint256 nowAvailable =
            hashBridgeOracleToken.balanceOf(address(this)).sub(funds.allocated);
    ...
    /**
     * @notice query the available amount of HBO for an oracle to withdraw
     */
    ...
    /**
     * @notice transfers the oracle's HBO to another address. Can only be called
     * by the oracle's admin.
     * @param _oracle is the oracle whose HBO is transferred
     * @param _recipient is the address to send the HBO to
     * @param _amount is the amount of HBO to send
     */
    function withdrawPayment(
        ...
        // Safe to downcast _amount because the total amount of HBO is less than 2^128.
        ...
        assert(hashBridgeOracleToken.transfer(_recipient, uint256(amount)));
    }

    /**
     * @notice transfers the owner's HBO to another address
     * @param _recipient is the address to send the HBO to
     * @param _amount is the amount of HBO to send
     */
        ...
        onlyOwner()
    {
        ...
        require(
            hashBridgeOracleToken.transfer(_recipient, _amount),
    ...
    /**
     * @notice called through HBO's transferAndCall to update available funds
